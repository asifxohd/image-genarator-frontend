                        ...
                        <div className="relative flex flex-col sm:w-[30rem] rounded-lg border-gray-400 bg-white shadow-lg px-4">
                            <div className="flex-auto p-6">
                                ...
                                <form  className="mb-4" action="#" method="POST">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="relative flex w-full flex-wrap items-stretch">
                                            <input type="password" className="relative block flex-auto cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-indigo-500 focus:bg-white focus:text-gray-600 focus:shadow" name="password" placeholder="············" autoComplete="" />
                                        </div>
                                    </div>
                                ...
                                <p className="mb-4 text-center">
                                    ...
                                    <Link to={'sign-up/'} className="cursor-pointer text-blue-500 no-underline hover:text-blue-500">
                                        Create an account
                                    </Link>
                                </p>
